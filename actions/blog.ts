...
export const listRelated = (blog: any) => {
...
export const listBlogsWithCategoriesAndTags = (skip: string, limit: string) => {
  const data = {
    limit,
    skip
  };
...
//删除博客
export const removeBlog = (id: string, token: string) => {
...
//更新博客
export const updateBlog = (blog: any, token: string, id: string) => {
